        ...
        <splide :options="options" @splide:mounted="splideMount" @splide:move="movedStart" @splide:moved="movedEnd" @splide:active="dotsplay" ref="bannerSlider">
            ...
            <splide-slide>
                <div class="slide-box blue">
                    <div class="slide-img">
                        <div class="slide-img-box" :style="{backgroundImage: 'url('+require(`@/assets/images/hero-image-01.webp`)+')'}"></div>
                    </div>
            ...
            <splide-slide>
                <div class="slide-box violet">
                    <div class="slide-img">
                        <div class="slide-img-box" :style="{backgroundImage: 'url('+require(`@/assets/images/hero-image-02.webp`)+')'}"></div>
                    </div>
                    <div class="slide-data">
                        <h2><a href="#" class="underline white"><span class="line">Sommeraktivitäten rund um Innsbruck</span></a></h2>
                    </div>
                </div>
            </splide-slide>
            <splide-slide>
                <div class="slide-box peach">
                    <div class="slide-img">
                        <div class="slide-img-box" :style="{backgroundImage: 'url('+require(`@/assets/images/hero-image-03.webp`)+')'}"></div>
                    </div>
                    <div class="slide-data">
                        <h2><a href="#" class="underline white"><span class="line">Übersicht aller Hundeparks in Innsbruck</span></a></h2>
                    </div>
                </div>
            </splide-slide>
    ...
    export default {
        ...
        data() {
            return {
                ...
                slides: [
                    { src: "hero-image-01", alt:"Infos zur Kindergarten Anmeldung", title:"Infos zur Kindergarten Anmeldung", key:"1", class:"blue"  },
                    { src: "hero-image-02", alt:"Sommeraktivitäten rund um Innsbruck", title:"Sommeraktivitäten rund um Innsbruck", key:"2", class:"violet" },
                    { src: "hero-image-03", alt:"Übersicht aller Hundeparks in Innsbruck", title:"Übersicht aller Hundeparks in Innsbruck", key:"3", class:"peach"  },
                ]
            };
        },
        methods: {
        ...
        mounted (){
            ...
            $('body').on('click', '.hero-slider .splide__slide', function(){
